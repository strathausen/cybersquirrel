...
class DNNTrader(tpqoa.tpqoa):
    ...
    def __init__(self, conf_file: str, instrument: str, bar_length: int, window: int, lags: int, model, mu: float, std: float, units: int):
    ...
    def define_strategy(self): # "strategy-specific"
        ...
        cols, df = create_features(df, self.instrument, self.window, self.lags)
